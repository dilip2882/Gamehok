...
class FollowTournamentUseCase @Inject constructor(
    private val tournamentRepository: TournamentRepository
) {
    suspend operator fun invoke(tournamentId: Int): Either<Failure, Unit> {
        return tournamentRepository.followTournament(tournamentId)
    }
} 